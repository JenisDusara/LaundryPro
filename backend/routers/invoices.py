...
SERVICE_ICONS = {
    "press":   "PR", "steam":   "ST", "dry":     "DC",
    "wash":    "WS", "iron":    "IR", "roll":    "RP",
    "colour":  "CL", "color":   "CL", "suit":    "SU",
    "blanket": "BL", "curtain": "CT", "saree":   "SR",
    "sari":    "SR", "blouse":  "BL", "shirt":   "SH",
    "pant":    "PT", "coat":    "CO",
}
...
def generate_invoice_pdf(customer: Customer, entries: list, month: int, year: int) -> BytesIO:
    ...
    TEAL_DARK = colors.HexColor("#164e63")
    TEAL_HDR  = colors.HexColor("#0891b2")
    ROW_ALT   = colors.HexColor("#e0f7fa")
    GREY      = colors.HexColor("#475569")
    BORDER    = colors.HexColor("#b2dfdb")
    NAVY      = colors.HexColor("#1e3a8a")
    WHITE     = colors.white
    CUST_BG1  = colors.HexColor("#e0f7fa")
    CUST_BG2  = colors.HexColor("#f0fdfe")
    ...
    # ── SHOP HEADER ──────────────────────────────────────────
    elements.append(p("Chamunda Laundry", size=22, bold=True, color="#164e63", align=TA_CENTER))
    elements.append(Spacer(1, 2*mm))
    elements.append(p("Ahmedabad, India  |  +91 1234567890", size=10, color="#475569", align=TA_CENTER))
