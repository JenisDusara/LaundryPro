    ...
    <section id="about" className="relative overflow-hidden py-20 sm:py-28">
      ...
      <Container className="relative">
          ...
          {about.highlights.map((h, i) => {
            ...
            return (
              <motion.div
                ...
                className="group relative overflow-hidden rounded-2xl border border-line bg-card p-6 text-center shadow-card transition-all duration-300 hover:-translate-y-1.5 hover:shadow-card-hover"
              >
                <span
        ...
        <motion.div
          ...
          className="mx-auto mt-6 max-w-3xl rounded-2xl border border-line bg-card p-6 shadow-card sm:p-8"
        >
